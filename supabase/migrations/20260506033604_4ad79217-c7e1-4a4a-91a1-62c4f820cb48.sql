CREATE OR REPLACE FUNCTION public.get_public_job_by_id(job_id_param uuid)
...
GRANT EXECUTE ON FUNCTION public.get_public_job_by_id(uuid) TO anon, authenticated;